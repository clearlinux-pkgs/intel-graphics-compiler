...
Version  : 1.0.3771
Release  : 43
URL      : https://github.com/intel/intel-graphics-compiler/archive/igc-1.0.3771.tar.gz
Source0  : https://github.com/intel/intel-graphics-compiler/archive/igc-1.0.3771.tar.gz
...
%prep
%setup -q -n intel-graphics-compiler-igc-1.0.3771
cd %{_builddir}/intel-graphics-compiler-igc-1.0.3771
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1587164196
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
...
%cmake .. -DIGC_PREFERRED_LLVM_VERSION=10
...
cp %{_builddir}/intel-graphics-compiler-igc-1.0.3771/IGC/BiFModule/Implementation/ExternalLibraries/libclc/LICENSE.TXT %{buildroot}/usr/share/package-licenses/intel-graphics-compiler/e92d77d1b61e0abf19a638a33635e8885ba36afd
cp %{_builddir}/intel-graphics-compiler-igc-1.0.3771/LICENSE.md %{buildroot}/usr/share/package-licenses/intel-graphics-compiler/1c5acacbd2594f1ff922d56805c4e2caecfdac08
pushd clr-build
%make_install
popd
...
rm -f %{buildroot}/usr/include/igc/cif/cif/builtins/*.cpp
rm -f %{buildroot}/usr/include/igc/cif/cif/builtins/memory/buffer/impl/*.cpp
rm -f %{buildroot}/usr/include/igc/cif/cif/export/*.cpp
rm -f %{buildroot}/usr/include/igc/cif/cif/import/*.cpp
rm -f %{buildroot}/usr/include/igc/cif/cif/os/*/*.cpp
rm -f %{buildroot}/usr/include/igc/ocl_igc_interface/impl/*.cpp
## install_append end

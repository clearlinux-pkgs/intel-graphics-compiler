...
Source0  : https://github.com/intel/intel-graphics-compiler/archive/igc-1.0.6.tar.gz
...
%prep
%setup -q -n intel-graphics-compiler-igc-1.0.6
%patch1 -p1
%patch2 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1559250198
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libiga64.so.1.0.6
/usr/lib64/libigc.so
/usr/lib64/libigc.so.1
/usr/lib64/libigc.so.1.0.6
/usr/lib64/libigdfcl.so
/usr/lib64/libigdfcl.so.1
/usr/lib64/libigdfcl.so.1.0.6

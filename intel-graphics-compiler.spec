...
Version  : 1.0.10
Release  : 26
URL      : https://github.com/intel/intel-graphics-compiler/archive/igc-1.0.10.tar.gz
Source0  : https://github.com/intel/intel-graphics-compiler/archive/igc-1.0.10.tar.gz
...
%prep
%setup -q -n intel-graphics-compiler-igc-1.0.10
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1565629426
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libiga64.so.1.0.10
/usr/lib64/libigc.so
/usr/lib64/libigc.so.1
/usr/lib64/libigc.so.1.0.10
/usr/lib64/libigdfcl.so
/usr/lib64/libigdfcl.so.1
/usr/lib64/libigdfcl.so.1.0.10

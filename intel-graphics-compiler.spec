...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1574191367
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/intel-graphics-compiler-igc-1.0.2805/IGC/BiFModule/Implementation/ExternalLibraries/libclc/LICENSE.TXT %{buildroot}/usr/share/package-licenses/intel-graphics-compiler/e92d77d1b61e0abf19a638a33635e8885ba36afd
cp %{_builddir}/intel-graphics-compiler-igc-1.0.2805/LICENSE.md %{buildroot}/usr/share/package-licenses/intel-graphics-compiler/1c5acacbd2594f1ff922d56805c4e2caecfdac08
pushd clr-build
%make_install
popd
